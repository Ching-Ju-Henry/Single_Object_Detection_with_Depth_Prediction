...
class YOLO_TF:
	fromfile = None
	tofile_img = 'output/out_TV4.jpg'
	tofile_txt = 'output/out_TV4.txt'
	imshow = True
	filewrite_img = True
	filewrite_txt = True
	disp_console = True
	...
	def detect_from_cvmat(self,img):
		...
		print self.sess.run(self.fc_30,feed_dict=in_dict)
		input_for_LSTM.append(self.sess.run(self.fc_30,feed_dict=in_dict))#!!!!!!!!!!!!!!!!!!!!!!!!
		#np.savetxt('/home/henry/rolo/YOLO_tensorflow/test/4096.txt',self.sess.run(self.fc_30,feed_dict=in_dict))#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	def interpret_output(self,output):
		...
		print classes_num_filtered, boxes_filtered, probs_filtered#!!!!!!!!!!!!!!!!
		input_for_LSTM.append(classes_num_filtered)#!!!!!!!!!!!!!!!!!!!!!
		print ("input_for_LSTM.append: ",input_for_LSTM)
